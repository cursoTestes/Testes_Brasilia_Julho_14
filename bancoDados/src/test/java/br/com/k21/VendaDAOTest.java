...
public class VendaDAOTest extends BaseDBTest {
	...
	@Test
	public void testTotal_Vendas_Para_Um_Vendedor_Inexistente() {
		// Arrange
		Vendedor vendedor = new Vendedor();
	...
	@Test
	public void testTotal_Vendas_Para_Uma_Venda() {
		// Arrange
		Vendedor vendedor = new Vendedor();
	...
	@Test
	public void testTotal_Vendas_Para_Duas_Vendas() {
		// Arrange
		Vendedor vendedor = new Vendedor();
	...
	@Test
	public void testTotal_Vendas_Para_Uma_Venda_Dois_Vendedores() {
		// Arrange
		Vendedor vendedor = new Vendedor();
		vendedor.setId(3);
		int entradaAno = 2013;
